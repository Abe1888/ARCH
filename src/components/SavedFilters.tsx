...
import { Bookmark, Plus, CreditCard as Edit2, Check, X } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import { useDocumentStore } from '../store/useDocumentStore';

export const SavedFilters: React.FC = () => {
  const { savedFilters, addSavedFilter, applySavedFilter, renameSavedFilter, filters } =
    useDocumentStore();
            ...
            {editingId === filter.id ? (
              ...
              <div className="group flex items-center gap-2 p-2 hover:bg-gray-50 rounded-lg transition-colors">
                ...
                <button
                  ...
                  className="p-1 text-gray-600 hover:bg-gray-100 rounded transition-colors opacity-0 group-hover:opacity-100 transition-opacity"
